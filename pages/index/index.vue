  ...
  <div>
          ...
          <div class="row row-50 align-items-lg-center justify-content-lg-between">
            <div class="col-lg-6 order-lg-2">
              <div class="animate-box">
                <div class="wow slideInRight" data-wow-delay="0.1s"> <img src="~/assets/images/home-8-584x472.png" alt="" width="584" height="472"/>
                </div>
              </div>
            </div>
            <div class="col-lg-6 col-xl-5 order-lg-1">
              ...
              <div class="button-group wow fadeIn" data-wow-delay="0.35s"><nuxt-link class="button button-primary button-shadow" to="/services">Learn More</nuxt-link></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row row-30 align-items-lg-center">
            <div class="col-lg-7 text-center text-lg-left">
              <div class="animate-box">
                <div class="wow slideInLeft" data-wow-delay="0.1s"><img src="~/assets/images/home-2-563x509.png" alt="" width="563" height="509"/>
                </div>
              </div>
            </div>
            <div class="col-lg-5 col-xl-5">
              ...
              <div class="button-block group-lg wow fadeIn" data-wow-delay="0.4s"> <nuxt-link class="button button-primary button-shadow" to="/about-us">Read More</nuxt-link><nuxt-link class="button button-default-outline" to="/contacts">Contact us</nuxt-link></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-lg bg-default section-decoration-2 section-decoration-2-mode">
        <div class="container">
          ...
          <services :servicesList="servicesList"></services>
        </div>
      </section>
      <!-- contact us-->
        ...
        <div class="container">
          <div class="row row-50 align-items-lg-center">
            <div class="col-lg-7 text-center order-lg-2">
              <div class="animate-box">
                <div class="block-img-decoration wow slideInRight"><img src="~/assets/images/home-7-423x565.png" alt="" width="423" height="565"/>
                </div>
              </div>
            </div>
            <div class="col-lg-5">
              ...
              <div class="button-block group-lg wow fadeIn" data-wow-delay="0.35s"><nuxt-link class="button button-primary button-shadow" to="/about-us">Read More</nuxt-link><nuxt-link class="button button-default-outline" to="/contacts">Get in Touch</nuxt-link></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="section-md bg-gray-200 section-decoration-3">
        <div class="container wow fadeIn" data-wow-delay="0.3s">
          <div class="row row-30 justify-content-lg-between align-items-md-end text-center">
            ...
            <div class="col-md-6 text-md-right"><nuxt-link class="button button-primary button-shadow" to="/portfolio">all projects</nuxt-link></div>
            <div class="col-12">
              <!-- Owl Carousel-->
              <div class="owl-carousel" data-items="1" data-sm-items="2" data-lg-items="3" data-dots="false" data-nav="true" data-stage-padding="0" data-loop="true" data-autoplay="5000" data-margin="30" data-mouse-drag="false">
                <div class="project-item" v-for="(item,index) in projectsList" :key="item.name+index">
                  <img :src="item.src" alt="" width="370" height="404"/>
                  <div class="project-item-caption context-dark">
                    <h2 class="project-item-title">{{item.name}}</h2><a class="button-link" href="#"> <span>View site</span><span class="icon fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  head () {
    return {
      title:"首页",
      meta: [
        {name:'keywords',hid: 'keywords',content:`首页关键字`},
        {name:'description',hid:'description',content:`首页描述`}
      ]
    }
  },
  asyncData({ app }) {
    ...
    const servicesList= [
      {
       svg:`<svg width="36" height="34" viewbox="0 0 36 34" fill="none" xmlns="http://www.w3.org/2000/svg">
       ...
       desc:"A great brand combines design and messaging to evoke emotion in your customers and drive strategy." 
      },
      {
       svg:`<svg width="36" height="26" viewbox="0 0 36 26" fill="none" xmlns="http://www.w3.org/2000/svg">
       ...
       name:"Graphic Design",
       desc:"Rich experience plus unlimited imagination create our successful service discovered by clients." 
      },
      {
       ...
       desc:"Creating and handling professional video is our strong point. It plays a major role in your digital business strategy." 
      },
      {
       svg:`<svg width="36" height="32" viewbox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
       ...
       name:"SEO",
       desc:"We provide everything your site needs to perform at its highest capabilities on the major search engines." 
      },
      {
       svg:`<svg width="36" height="36" viewbox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
       ...
       desc:"With digital marketing, your business can expand into new areas and achieve tremendous accomplishments." 
      },
      {
       svg:`<svg width="36" height="32" viewbox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
       ...
       name:"Infographics",
       desc:"Turn your data into captivating artwork that will keep your audience engaged. Our team can help you with it." 
      }
    ]

    const projectsList = [
      {
        src:require("~/assets/images/project-1-370x404.jpg"),
        name:`Consulting Company “Impuls”`,
      },
      {
        src:require("~/assets/images/project-2-370x404.jpg"),
        name:"Travel Agency &quot;Tour Up&quot;",
      },
      {
        src:require("~/assets/images/project-3-370x404.jpg"),
        name:"Restaurant &quot;Little Italy",
      },
      {
        src:require("~/assets/images/project-4-370x404.jpg"),
        name:"Business News Portal",
      },
      {
        src:require("~/assets/images/project-5-370x404.jpg"),
        name:"Car Repair Workshop &quot;Auto Quarter",
      }
    ]
    return new Promise((resolve) => {
      setTimeout( () => {
        resolve({ servicesList , projectsList})
      }, 1000)
    })
  }
}
